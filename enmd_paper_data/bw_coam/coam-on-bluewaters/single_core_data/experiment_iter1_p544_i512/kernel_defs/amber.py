...
_KERNEL_INFO = {
    ...
    "machine_configs": 
    {
        ...
        {
            "environment"   : {},
            "pre_exec" : [" module swap PrgEnv-cray PrgEnv-gnu"," module add cray-netcdf","module add fftw","export PATH=$PATH:/projects/sciteam/gkd/amber_bw/amber/bin","export AMBERHOME=/projects/sciteam/gkd/amber_bw/amber"],
            "executable" : ["sander"],
            "uses_mpi"   : False
        }            
    }
