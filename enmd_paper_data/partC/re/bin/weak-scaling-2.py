...
def gen_graph():
    ...
    name1 = 'execution_profile_rp.session.antons-pc.antons.016755.0000_smic_1280'
    ...
    data_times4, \
    rp_overhead4, \
    enmd_overhead4 = read_data(name1, 'cycle_1')
    ...
    name1 = 'execution_profile_rp.session.antons-pc.antons.016755.0001_smid_2560'
    ...
    # 1280/1280
    ov1 = get_overhead('2015-11-15 19:30:48.650711', '2015-11-15 19:30:55.982871')
    ov2 =  get_overhead('2015-11-15 21:41:36.047437', '2015-11-15 21:42:12.760995')
    enmd_core_times.append(ov1 + ov2)
    enmd_core_times_err.append(0.1)
    ...
    enmd_core_times.append(ov1 + ov2)
    enmd_core_times_err.append(0.15)
    ...
    axarr[1].legend((p5[0], p4[0]), ('simulation execution time',  'exchange execution time'), loc="upper left")
