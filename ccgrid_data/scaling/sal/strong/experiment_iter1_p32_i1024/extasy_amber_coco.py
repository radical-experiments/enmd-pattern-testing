...
class Extasy_CocoAmber_Static(SimulationAnalysisLoop):
    ...
    def analysis_step(self, iteration, instance):
        ...
        num_of_ana_inst = int(Kconfig.num_CUs)/32
	for iter in range(1,iteration+1):
#            for i in range(1,Kconfig.num_CUs+1):
	     for i in range(1+(instance-1)*32, instance*32 + 1):
        ...
        for i in range(0,32):
            k1.copy_output_data = k1.copy_output_data + ['pdbs{1}.pdb > $PRE_LOOP/pentaopt{0}{2}.pdb'.format(iteration,i,(instance-1)*32+i)]
...
if __name__ == "__main__":
    ...
    try:
        ...
        coco_amber_static = Extasy_CocoAmber_Static(maxiterations=Kconfig.num_iterations, simulation_instances=Kconfig.num_CUs, analysis_instances=Kconfig.num_CUs/32)
