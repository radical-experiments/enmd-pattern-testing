    ...
    try:
        ...
        # number of cores and runtime.
            ...
            for item in pairings:
                ...
                profile_index_string = "profile_{0}_{1}.csv".format(core_count,iteration)
                ...
                os.system("mv {0} {1}".format(original_profile,profile_index_string))

                sender = "nikhil_shenoy10@yahoo.com"
                receiver = "nrs76@scarletmail.rutgers.edu"

                message = '''From: Nikhil Shenoy <{0}>
                             To: Nikhil Shenoy <{1}>
                             Subject: {2}-{3} completed'''.format(sender,receiver,core_count,iteration)
