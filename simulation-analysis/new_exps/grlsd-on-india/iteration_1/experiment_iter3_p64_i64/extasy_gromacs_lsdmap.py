...
class Gromacs_LSDMap(SimulationAnalysisLoop):
  # TODO Vivek: add description.
    ...
    def analysis_step(self, iteration, instance):
        ...
        pre_ana.copy_output_data = ['tmp.gro > $PRE_LOOP/tmp.gro','tmpha.gro > $PRE_LOOP/tmpha.gro']

	#pre_ana2 = Kernel(name="md.pre_lsdmap_2")
	#pre_ana2.link_input_data = ['$PRE_LOOP/tmp.gro > tmp.gro']
	#pre_ana2.copy_output_data = ["tmpha.gro > $PRE_LOOP/tmpha.gro"]
